...
public class addNotes extends JPanel {
    ...
    public void addNotes(NotePad notePad) throws FileNotFoundException, IOException, ClassNotFoundException{
        this.notePad = notePad;
        String[] noteIndex = new String[notePad.indexOf(notePad)];
